...
class Keygrouptools:
    def __init__(self, z48):
        ...
        self.get_edit_mode_cmd = Command('_', '\x13\x02', 'get_edit_mode', (), None)
        ...
        self.set_low_note_cmd = Command('_', '\x12\x04', 'set_low_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_high_note_cmd = Command('_', '\x12\x05', 'set_high_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_mute_group_cmd = Command('_', '\x12\x06', 'set_mute_group', (aksy.devices.akai.sysex_types.BYTE,), None)
