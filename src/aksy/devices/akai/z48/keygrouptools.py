...
class Keygrouptools:
    def __init__(self, z48):
        self.sampler = z48
        self.set_curr_keygroup_cmd = Command(b'_', b'\x10\x01', 'keygrouptools', 'set_curr_keygroup', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_curr_keygroup_cmd = Command(b'_', b'\x10\x02', 'keygrouptools', 'get_curr_keygroup', (), None)
        self.get_group_id_cmd = Command(b'_', b'\x13\x01', 'keygrouptools', 'get_group_id', (), None)
        self.get_edit_mode_cmd = Command(b'_', b'\x13\x02', 'keygrouptools', 'get_edit_mode', (), None)
        self.get_low_note_cmd = Command(b'_', b'\x13\x04', 'keygrouptools', 'get_low_note', (), None)
        self.get_high_note_cmd = Command(b'_', b'\x13\x05', 'keygrouptools', 'get_high_note', (), None)
        self.get_mute_group_cmd = Command(b'_', b'\x13\x06', 'keygrouptools', 'get_mute_group', (), None)
        self.get_fx_override_cmd = Command(b'_', b'\x13\x07', 'keygrouptools', 'get_fx_override', (), None)
        self.get_fx_send_level_cmd = Command(b'_', b'\x13\x08', 'keygrouptools', 'get_fx_send_level', (), None)
        self.get_zone_xfade_cmd = Command(b'_', b'\x13\x09', 'keygrouptools', 'get_zone_xfade', (), None)
        self.get_zone_xfade_type_cmd = Command(b'_', b'\x13\x0A', 'keygrouptools', 'get_zone_xfade_type', (), None)
        self.get_polyphony_cmd = Command(b'_', b'\x13\x0E', 'keygrouptools', 'get_polyphony', (), None)
        self.get_zone_xfade_ctrl_no_cmd = Command(b'_', b'\x13\x0F', 'keygrouptools', 'get_zone_xfade_ctrl_no', (), None)
        self.get_tune_cmd = Command(b'_', b'\x13\x10', 'keygrouptools', 'get_tune', (), None)
        self.get_level_cmd = Command(b'_', b'\x13\x11', 'keygrouptools', 'get_level', (), None)
        self.get_play_trigger_cmd = Command(b'_', b'\x13\x18', 'keygrouptools', 'get_play_trigger', (), None)
        self.get_play_trigger_velocity_cmd = Command(b'_', b'\x13\x19', 'keygrouptools', 'get_play_trigger_velocity', (), None)
        self.get_play_toggle_note_cmd = Command(b'_', b'\x13\x1A', 'keygrouptools', 'get_play_toggle_note', (), None)
        self.get_filter_cmd = Command(b'_', b'\x13\x20', 'keygrouptools', 'get_filter', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_filter_cutoff_cmd = Command(b'_', b'\x13\x21', 'keygrouptools', 'get_filter_cutoff', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_filter_resonance_cmd = Command(b'_', b'\x13\x22', 'keygrouptools', 'get_filter_resonance', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_filter_attenuation_cmd = Command(b'_', b'\x13\x23', 'keygrouptools', 'get_filter_attenuation', (), None)
        self.get_envelope_rate1_cmd = Command(b'_', b'\x13\x30', 'keygrouptools', 'get_envelope_rate1', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_level1_cmd = Command(b'_', b'\x13\x31', 'keygrouptools', 'get_envelope_level1', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_rate2_cmd = Command(b'_', b'\x13\x32', 'keygrouptools', 'get_envelope_rate2', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_level2_cmd = Command(b'_', b'\x13\x33', 'keygrouptools', 'get_envelope_level2', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_rate3_cmd = Command(b'_', b'\x13\x34', 'keygrouptools', 'get_envelope_rate3', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_level3_cmd = Command(b'_', b'\x13\x35', 'keygrouptools', 'get_envelope_level3', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_rate4_cmd = Command(b'_', b'\x13\x36', 'keygrouptools', 'get_envelope_rate4', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_level4_cmd = Command(b'_', b'\x13\x37', 'keygrouptools', 'get_envelope_level4', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_reference_cmd = Command(b'_', b'\x13\x42', 'keygrouptools', 'get_envelope_reference', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_attack_hold_cmd = Command(b'_', b'\x13\x43', 'keygrouptools', 'get_attack_hold', (), None)
        self.get_lfo_rate_cmd = Command(b'_', b'\x13\x50', 'keygrouptools', 'get_lfo_rate', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_delay_cmd = Command(b'_', b'\x13\x51', 'keygrouptools', 'get_lfo_delay', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_depth_cmd = Command(b'_', b'\x13\x52', 'keygrouptools', 'get_lfo_depth', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_lfo_waveform_cmd = Command(b'_', b'\x13\x53', 'keygrouptools', 'get_lfo_waveform', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_phase_cmd = Command(b'_', b'\x13\x54', 'keygrouptools', 'get_lfo_phase', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_shift_cmd = Command(b'_', b'\x13\x55', 'keygrouptools', 'get_lfo_shift', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_midi_sync_cmd = Command(b'_', b'\x13\x56', 'keygrouptools', 'get_lfo_midi_sync', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_midi_clock_sync_div_cmd = Command(b'_', b'\x13\x57', 'keygrouptools', 'get_midi_clock_sync_div', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_retrigger_cmd = Command(b'_', b'\x13\x58', 'keygrouptools', 'get_lfo_retrigger', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_sync_cmd = Command(b'_', b'\x13\x59', 'keygrouptools', 'get_lfo_sync', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_group_id_cmd = Command(b'_', b'\x12\x01', 'keygrouptools', 'set_group_id', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_edit_mode_cmd = Command(b'_', b'\x12\x02', 'keygrouptools', 'set_edit_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_low_note_cmd = Command(b'_', b'\x12\x04', 'keygrouptools', 'set_low_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_high_note_cmd = Command(b'_', b'\x12\x05', 'keygrouptools', 'set_high_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_mute_group_cmd = Command(b'_', b'\x12\x06', 'keygrouptools', 'set_mute_group', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_fx_override_cmd = Command(b'_', b'\x12\x07', 'keygrouptools', 'set_fx_override', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_fx_send_level_cmd = Command(b'_', b'\x12\x08', 'keygrouptools', 'set_fx_send_level', (aksy.devices.akai.sysex_types.SWORD,), None)
        self.set_zone_xfade_cmd = Command(b'_', b'\x12\x09', 'keygrouptools', 'set_zone_xfade', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_zone_xfade_type_cmd = Command(b'_', b'\x12\x0A', 'keygrouptools', 'set_zone_xfade_type', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_polyphony_cmd = Command(b'_', b'\x12\x0E', 'keygrouptools', 'set_polyphony', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_zone_xfade_ctrl_no_cmd = Command(b'_', b'\x12\x0F', 'keygrouptools', 'set_zone_xfade_ctrl_no', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_tune_cmd = Command(b'_', b'\x12\x10', 'keygrouptools', 'set_tune', (aksy.devices.akai.sysex_types.SWORD,), None)
        self.set_level_cmd = Command(b'_', b'\x12\x11', 'keygrouptools', 'set_level', (aksy.devices.akai.sysex_types.SWORD,), None)
        self.set_play_trigger_cmd = Command(b'_', b'\x12\x18', 'keygrouptools', 'set_play_trigger', (), None)
        self.set_play_trigger_vel_cmd = Command(b'_', b'\x12\x19', 'keygrouptools', 'set_play_trigger_vel', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_play_toggle_note_cmd = Command(b'_', b'\x12\x1A', 'keygrouptools', 'set_play_toggle_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_filter_cmd = Command(b'_', b'\x12\x20', 'keygrouptools', 'set_filter', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_filter_cutoff_cmd = Command(b'_', b'\x12\x21', 'keygrouptools', 'set_filter_cutoff', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_filter_resonance_cmd = Command(b'_', b'\x12\x22', 'keygrouptools', 'set_filter_resonance', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_filter_atten_cmd = Command(b'_', b'\x12\x23', 'keygrouptools', 'set_filter_atten', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_envelope_rate1_cmd = Command(b'_', b'\x12\x30', 'keygrouptools', 'set_envelope_rate1', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_level1_cmd = Command(b'_', b'\x12\x31', 'keygrouptools', 'set_envelope_level1', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_rate2_cmd = Command(b'_', b'\x12\x32', 'keygrouptools', 'set_envelope_rate2', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_level2_cmd = Command(b'_', b'\x12\x33', 'keygrouptools', 'set_envelope_level2', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_rate3_cmd = Command(b'_', b'\x12\x34', 'keygrouptools', 'set_envelope_rate3', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_level3_cmd = Command(b'_', b'\x12\x35', 'keygrouptools', 'set_envelope_level3', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_rate4_cmd = Command(b'_', b'\x12\x36', 'keygrouptools', 'set_envelope_rate4', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_level4_cmd = Command(b'_', b'\x12\x37', 'keygrouptools', 'set_envelope_level4', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_envelope_reference_cmd = Command(b'_', b'\x12\x42', 'keygrouptools', 'set_envelope_reference', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_attack_hold_cmd = Command(b'_', b'\x12\x43', 'keygrouptools', 'set_attack_hold', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_lfo_rate_cmd = Command(b'_', b'\x12\x50', 'keygrouptools', 'set_lfo_rate', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_delay_cmd = Command(b'_', b'\x12\x51', 'keygrouptools', 'set_lfo_delay', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_depth_cmd = Command(b'_', b'\x12\x52', 'keygrouptools', 'set_lfo_depth', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_waveform_cmd = Command(b'_', b'\x12\x53', 'keygrouptools', 'set_lfo_waveform', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_phase_cmd = Command(b'_', b'\x12\x54', 'keygrouptools', 'set_lfo_phase', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.set_lfo_shift_cmd = Command(b'_', b'\x12\x55', 'keygrouptools', 'set_lfo_shift', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.SBYTE), None)
        self.set_lfo_midi_sync_cmd = Command(b'_', b'\x12\x56', 'keygrouptools', 'set_lfo_midi_sync', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BOOL), None)
        self.set_midi_clock_sync_div_cmd = Command(b'_', b'\x12\x57', 'keygrouptools', 'set_midi_clock_sync_div', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_retrigger_cmd = Command(b'_', b'\x12\x58', 'keygrouptools', 'set_lfo_retrigger', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.set_lfo_sync_cmd = Command(b'_', b'\x12\x59', 'keygrouptools', 'set_lfo_sync', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
