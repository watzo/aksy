...
class Keygrouptools:
    def __init__(self, z48):
        self.z48 = z48
        self.get_group_id_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x01', 'get_group_id', (), None)
        self.get_edit_mode_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x02', 'get_edit_mode', (), None)
        self.get_low_note_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x04', 'get_low_note', (), None)
        self.get_high_note_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x05', 'get_high_note', (), None)
        self.get_mute_group_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x06', 'get_mute_group', (), None)
        self.get_FX_override_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x07 ', 'get_FX_override', (), None)
        self.get_FX_send_level_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x08', 'get_FX_send_level', (), None)
        self.get_zone_crossfade_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x09', 'get_zone_crossfade', (), None)
        self.get_crossfade_type_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x0A', 'get_crossfade_type', (), None)
        self.get_polyphoy_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x0E', 'get_polyphoy', (), None)
        self.get_zone_crossfade_ctrl_no_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x0F', 'get_zone_crossfade_ctrl_no', (), None)
        self.get_tune_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x10', 'get_tune', (), None)
        self.get_keygroup_level_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x11 ', 'get_keygroup_level', (), None)
        self.get_play_trigger_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x18', 'get_play_trigger', (), None)
        self.get_player_trigger_velocity_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x19', 'get_player_trigger_velocity', (), None)
        self.get_play_toggle_note_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x1A ', 'get_play_toggle_note', (), None)
        self.get_filter_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x20', 'get_filter', (), None)
        self.get_filter_cutoff_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x21', 'get_filter_cutoff', (), None)
        self.get_filter_resonance_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x22', 'get_filter_resonance', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_filter_attenuation_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x23', 'get_filter_attenuation', (), None)
        self.get_envelope_rate_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x30', 'get_envelope_rate', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_level1_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x31', 'get_envelope_level1', (), None)
        self.get_envelope_rate2_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x32', 'get_envelope_rate2', (), None)
        self.get_envelope_level2_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x33', 'get_envelope_level2', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_rate3_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x34', 'get_envelope_rate3', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_level3_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x35', 'get_envelope_level3', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_rate4_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x36', 'get_envelope_rate4', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_level4_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x37', 'get_envelope_level4', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_envelope_reference_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x42', 'get_envelope_reference', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_attack_hold_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x43 ', 'get_attack_hold', (), None)
        self.get_lfo_rate_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x50', 'get_lfo_rate', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_delay_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x51 ', 'get_lfo_delay', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_depth_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x52 ', 'get_lfo_depth', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_lfo_waveform_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x53', 'get_lfo_waveform', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_lfo_phase_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x54 ', 'get_lfo_phase', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_LFO_shift_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x55', 'get_LFO_shift', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_LFO_midi_sync_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x56', 'get_LFO_midi_sync', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_midi_clock_sync_div_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x57', 'get_midi_clock_sync_div', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_LFO_retrigger_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x58 ', 'get_LFO_retrigger', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_LFO_sync_cmd = aksy.devices.akai.sysex.Command('_', '\x13\x59', 'get_LFO_sync', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_group_id_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x01', 'set_group_id', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_edit_mode_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x02', 'set_edit_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_low_note_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x04', 'set_low_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_high_note_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x05', 'set_high_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_mute_group_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x06', 'set_mute_group', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_fx_override_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x07', 'set_fx_override', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_fx_send_level_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x08', 'set_fx_send_level', (aksy.devices.akai.sysex_types.SWORD,), None)
        self.set_zone_xfade_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x09', 'set_zone_xfade', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_xfade_type_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x0A', 'set_xfade_type', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_polyphony_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x0E', 'set_polyphony', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_zone_xfade_ctrl_no_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x0F', 'set_zone_xfade_ctrl_no', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_tune_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x10', 'set_tune', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_keygroup_level_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x11', 'set_keygroup_level', (aksy.devices.akai.sysex_types.SWORD,), None)
        self.set_play_trigger_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x18', 'set_play_trigger', (), None)
        self.set_play_trigger_vel_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x19', 'set_play_trigger_vel', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_play_toggle_note_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x1A ', 'set_play_toggle_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_filter_mode_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x20', 'set_filter_mode', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_filter_cutoff_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x21', 'set_filter_cutoff', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_filter_resonance_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x22', 'set_filter_resonance', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_filter_atten_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x23', 'set_filter_atten', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_env_rate1_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x30', 'set_env_rate1', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_level1_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x31', 'set_env_level1', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_rate2_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x32', 'set_env_rate2', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_level2_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x33', 'set_env_level2', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_rate3_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x34', 'set_env_rate3', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_level3_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x35', 'set_env_level3', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_rate4_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x36', 'set_env_rate4', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_level4_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x37', 'set_env_level4', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_env_ref_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x42', 'set_env_ref', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_attack_hold_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x43', 'set_attack_hold', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_lfo_rate_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x50', 'set_lfo_rate', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_delay_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x51', 'set_lfo_delay', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_depth_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x52', 'set_lfo_depth', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_waveform_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x53', 'set_lfo_waveform', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_lfo_phase_cmd = aksy.devices.akai.sysex.Command('_', '\x12\x54', 'set_lfo_phase', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
    ...
    def get_keygroup_level(self):
        ...
        Returns:
            aksy.devices.akai.sysex_types.SWORD
        """
        return self.z48.execute(self.get_keygroup_level_cmd, ())
    ...
    def set_keygroup_level(self, arg0):
        ...
        """
        return self.z48.execute(self.set_keygroup_level_cmd, (arg0, ))
