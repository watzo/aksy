...
class Systemtools:
    def __init__(self, z48):
        self.sampler = z48
        self.get_os_software_version_cmd = Command(b'_', b'\x04\x00', 'systemtools', 'get_os_software_version', (), None)
        self.get_os_subversion_cmd = Command(b'_', b'\x04\x01', 'systemtools', 'get_os_subversion', (), None)
        self.get_sampler_model_cmd = Command(b'_', b'\x04\x04', 'systemtools', 'get_sampler_model', (), None)
        self.get_supported_filetypes_cmd = Command(b'_', b'\x04\x08', 'systemtools', 'get_supported_filetypes', (), None)
        self.get_perc_free_wave_mem_cmd = Command(b'_', b'\x04\x10', 'systemtools', 'get_perc_free_wave_mem', (), None)
        self.get_perc_free_cpu_mem_cmd = Command(b'_', b'\x04\x11', 'systemtools', 'get_perc_free_cpu_mem', (), None)
        self.get_wave_mem_size_cmd = Command(b'_', b'\x04\x12', 'systemtools', 'get_wave_mem_size', (), None)
        self.get_free_wave_mem_size_cmd = Command(b'_', b'\x04\x13', 'systemtools', 'get_free_wave_mem_size', (), None)
        self.clear_sampler_mem_cmd = Command(b'_', b'\x04\x18', 'systemtools', 'clear_sampler_mem', (), None)
        self.purge_unused_cmd = Command(b'_', b'\x04\x19', 'systemtools', 'purge_unused', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.tag_unused_cmd = Command(b'_', b'\x04\x1A', 'systemtools', 'tag_unused', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.compact_wave_mem_cmd = Command(b'_', b'\x04\x20', 'systemtools', 'compact_wave_mem', (), None)
        self.cancel_compact_wave_mem_cmd = Command(b'_', b'\x04\x21', 'systemtools', 'cancel_compact_wave_mem', (), None)
        self.get_compact_wave_mem_progress_cmd = Command(b'_', b'\x04\x22', 'systemtools', 'get_compact_wave_mem_progress', (), None)
        self.get_async_operation_state_cmd = Command(b'_', b'\x04\x30', 'systemtools', 'get_async_operation_state', (), None)
        self.cancel_curr_async_operation_cmd = Command(b'_', b'\x04\x31', 'systemtools', 'cancel_curr_async_operation', (), None)
        self.get_sampler_name_cmd = Command(b'_', b'\x07\x01', 'systemtools', 'get_sampler_name', (), None)
        self.get_scsi_id_cmd = Command(b'_', b'\x07\x02', 'systemtools', 'get_scsi_id', (), None)
        self.get_master_tune_cmd = Command(b'_', b'\x07\x03', 'systemtools', 'get_master_tune', (), None)
        self.get_master_level_cmd = Command(b'_', b'\x07\x04', 'systemtools', 'get_master_level', (), None)
        self.get_midi_mode_cmd = Command(b'_', b'\x07\x05', 'systemtools', 'get_midi_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.is_qlink_local_ctrl_enabled_cmd = Command(b'_', b'\x07\x06', 'systemtools', 'is_qlink_local_ctrl_enabled', (), None)
        self.is_default_items_enabled_cmd = Command(b'_', b'\x07\x07', 'systemtools', 'is_default_items_enabled', (), None)
        self.get_midi_file_save_format_cmd = Command(b'_', b'\x07\x08', 'systemtools', 'get_midi_file_save_format', (), None)
        self.get_cdr_write_speed_cmd = Command(b'_', b'\x07\x09', 'systemtools', 'get_cdr_write_speed', (), None)
        self.get_cdr_write_mode_cmd = Command(b'_', b'\x07\x0A', 'systemtools', 'get_cdr_write_mode', (), None)
        self.is_front_panel_locked_cmd = Command(b'_', b'\x07\x10', 'systemtools', 'is_front_panel_locked', (), None)
        self.get_display_contrast_cmd = Command(b'_', b'\x07\x11', 'systemtools', 'get_display_contrast', (), None)
        self.get_note_display_cmd = Command(b'_', b'\x07\x12', 'systemtools', 'get_note_display', (), None)
        self.get_date_format_cmd = Command(b'_', b'\x07\x13', 'systemtools', 'get_date_format', (), None)
        self.get_time_format_cmd = Command(b'_', b'\x07\x14', 'systemtools', 'get_time_format', (), None)
        self.get_waveform_view_scale_cmd = Command(b'_', b'\x07\x18', 'systemtools', 'get_waveform_view_scale', (), None)
        self.get_waveform_view_type_cmd = Command(b'_', b'\x07\x19', 'systemtools', 'get_waveform_view_type', (), None)
        self.get_waveform_view_fill_cmd = Command(b'_', b'\x07\x1A', 'systemtools', 'get_waveform_view_fill', (), None)
        self.get_item_sort_mode_cmd = Command(b'_', b'\x07\x1B', 'systemtools', 'get_item_sort_mode', (), None)
        self.get_year_cmd = Command(b'_', b'\x07\x20', 'systemtools', 'get_year', (), None)
        self.get_month_cmd = Command(b'_', b'\x07\x21', 'systemtools', 'get_month', (), None)
        self.get_day_cmd = Command(b'_', b'\x07\x22', 'systemtools', 'get_day', (), None)
        self.get_day_of_week_cmd = Command(b'_', b'\x07\x23', 'systemtools', 'get_day_of_week', (), None)
        self.get_hours_cmd = Command(b'_', b'\x07\x24', 'systemtools', 'get_hours', (), None)
        self.get_mins_cmd = Command(b'_', b'\x07\x25', 'systemtools', 'get_mins', (), None)
        self.get_secs_cmd = Command(b'_', b'\x07\x26', 'systemtools', 'get_secs', (), None)
        self.get_system_clock_cmd = Command(b'_', b'\x07\x30', 'systemtools', 'get_system_clock', (), None)
        self.get_dig_sync_cmd = Command(b'_', b'\x07\x31', 'systemtools', 'get_dig_sync', (), None)
        self.get_dig_format_cmd = Command(b'_', b'\x07\x32', 'systemtools', 'get_dig_format', (), None)
        self.get_adat_main_out_cmd = Command(b'_', b'\x07\x33', 'systemtools', 'get_adat_main_out', (), None)
        self.get_play_mode_cmd = Command(b'_', b'\x07\x40', 'systemtools', 'get_play_mode', (), None)
        self.get_prog_monitor_mode_cmd = Command(b'_', b'\x07\x41', 'systemtools', 'get_prog_monitor_mode', (), None)
        self.get_sample_monitor_mode_cmd = Command(b'_', b'\x07\x42', 'systemtools', 'get_sample_monitor_mode', (), None)
        self.get_play_key_note_cmd = Command(b'_', b'\x07\x48', 'systemtools', 'get_play_key_note', (), None)
        self.get_play_key_velocity_cmd = Command(b'_', b'\x07\x49', 'systemtools', 'get_play_key_velocity', (), None)
        self.get_play_key_midi_channel_cmd = Command(b'_', b'\x07\x4a', 'systemtools', 'get_play_key_midi_channel', (), None)
        self.get_play_key_echo_cmd = Command(b'_', b'\x07\x4b', 'systemtools', 'get_play_key_echo', (), None)
        self.get_prog_change_enable_cmd = Command(b'_', b'\x07\x4c', 'systemtools', 'get_prog_change_enable', (), None)
        self.get_autoload_enable_cmd = Command(b'_', b'\x07\x4d', 'systemtools', 'get_autoload_enable', (), None)
        self.get_global_pad_mode_cmd = Command(b'_', b'\x07\x50', 'systemtools', 'get_global_pad_mode', (), None)
        self.get_pad_midi_channel_cmd = Command(b'_', b'\x07\x51', 'systemtools', 'get_pad_midi_channel', (), None)
        self.get_pad_sensitivity_cmd = Command(b'_', b'\x07\x52', 'systemtools', 'get_pad_sensitivity', (), None)
        self.get_def_note_assign_cmd = Command(b'_', b'\x07\x53', 'systemtools', 'get_def_note_assign', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_chrom_start_note_cmd = Command(b'_', b'\x07\x54', 'systemtools', 'get_chrom_start_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_sampler_name_cmd = Command(b'_', b'\x06\x01', 'systemtools', 'set_sampler_name', (aksy.devices.akai.sysex_types.STRING,), None)
        self.set_scsi_id_cmd = Command(b'_', b'\x06\x02', 'systemtools', 'set_scsi_id', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_master_tune_cmd = Command(b'_', b'\x06\x03', 'systemtools', 'set_master_tune', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_master_level_cmd = Command(b'_', b'\x06\x04', 'systemtools', 'set_master_level', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_midi_out_thru_cmd = Command(b'_', b'\x06\x05', 'systemtools', 'set_midi_out_thru', (), None)
        self.set_qlink_local_control_cmd = Command(b'_', b'\x06\x06', 'systemtools', 'set_qlink_local_control', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_create_default_items_cmd = Command(b'_', b'\x06\x07', 'systemtools', 'set_create_default_items', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_midi_file_save_format_cmd = Command(b'_', b'\x06\x08', 'systemtools', 'set_midi_file_save_format', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_cdr_write_speed_cmd = Command(b'_', b'\x06\x09', 'systemtools', 'set_cdr_write_speed', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_cdr_write_mode_cmd = Command(b'_', b'\x06\x0a', 'systemtools', 'set_cdr_write_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_front_panel_lockout_state_cmd = Command(b'_', b'\x06\x10', 'systemtools', 'set_front_panel_lockout_state', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_display_contrast_cmd = Command(b'_', b'\x06\x11', 'systemtools', 'set_display_contrast', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_note_display_cmd = Command(b'_', b'\x06\x12', 'systemtools', 'set_note_display', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_date_display_format_cmd = Command(b'_', b'\x06\x13', 'systemtools', 'set_date_display_format', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_time_display_format_cmd = Command(b'_', b'\x06\x14', 'systemtools', 'set_time_display_format', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_waveform_view_scale_cmd = Command(b'_', b'\x06\x18', 'systemtools', 'set_waveform_view_scale', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_waveform_view_type_cmd = Command(b'_', b'\x06\x19', 'systemtools', 'set_waveform_view_type', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_waveform_view_fill_cmd = Command(b'_', b'\x06\x1a', 'systemtools', 'set_waveform_view_fill', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_item_sort_mode_cmd = Command(b'_', b'\x06\x1b', 'systemtools', 'set_item_sort_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_year_cmd = Command(b'_', b'\x06\x20', 'systemtools', 'set_year', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_month_cmd = Command(b'_', b'\x06\x21', 'systemtools', 'set_month', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_day_cmd = Command(b'_', b'\x06\x22', 'systemtools', 'set_day', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_day_of_week_cmd = Command(b'_', b'\x06\x23', 'systemtools', 'set_day_of_week', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_hours_cmd = Command(b'_', b'\x06\x24', 'systemtools', 'set_hours', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_minutes_cmd = Command(b'_', b'\x06\x25', 'systemtools', 'set_minutes', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_seconds_cmd = Command(b'_', b'\x06\x26', 'systemtools', 'set_seconds', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_system_clock_cmd = Command(b'_', b'\x06\x30', 'systemtools', 'set_system_clock', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_digital_out_sync_cmd = Command(b'_', b'\x06\x31', 'systemtools', 'set_digital_out_sync', (), None)
        self.set_digital_format_cmd = Command(b'_', b'\x06\x32', 'systemtools', 'set_digital_format', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_adat_main_out_cmd = Command(b'_', b'\x06\x33', 'systemtools', 'set_adat_main_out', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_play_mode_cmd = Command(b'_', b'\x06\x40', 'systemtools', 'set_play_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_program_monitor_mode_cmd = Command(b'_', b'\x06\x41', 'systemtools', 'set_program_monitor_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_sample_monitor_mode_cmd = Command(b'_', b'\x06\x42', 'systemtools', 'set_sample_monitor_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_play_key_note_cmd = Command(b'_', b'\x06\x48', 'systemtools', 'set_play_key_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_play_key_velocity_cmd = Command(b'_', b'\x06\x49', 'systemtools', 'set_play_key_velocity', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_play_key_midi_channel_cmd = Command(b'_', b'\x06\x4a', 'systemtools', 'set_play_key_midi_channel', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_play_key_echo_cmd = Command(b'_', b'\x06\x4b', 'systemtools', 'set_play_key_echo', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_program_change_enable_cmd = Command(b'_', b'\x06\x4c', 'systemtools', 'set_program_change_enable', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_autoload_enable_cmd = Command(b'_', b'\x06\x4d', 'systemtools', 'set_autoload_enable', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_global_pad_mode_cmd = Command(b'_', b'\x05\x50', 'systemtools', 'set_global_pad_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_pad_midi_channel_cmd = Command(b'_', b'\x06\x51', 'systemtools', 'set_pad_midi_channel', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_pad_sensitivity_cmd = Command(b'_', b'\x06\x52', 'systemtools', 'set_pad_sensitivity', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_default_note_assignment_cmd = Command(b'_', b'\x06\x53', 'systemtools', 'set_default_note_assignment', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_chromatic_start_note_cmd = Command(b'_', b'\x06\x54', 'systemtools', 'set_chromatic_start_note', (aksy.devices.akai.sysex_types.BYTE,), None)
