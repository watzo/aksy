...
class Multifxtools:
    def __init__(self, z48):
        ...
        self.get_no_cmd = Command('_', '\x24\x20', 'get_no', (), None)
        self.get_name_cmd = Command('_', '\x24\x21', 'get_name', (aksy.devices.akai.sysex_types.WORD,), None)
        self.get_id_cmd = Command('_', '\x24\x22', 'get_id', (aksy.devices.akai.sysex_types.WORD,), None)
        self.get_param_index_output_ctrl_cmd = Command('_', '\x24\x24', 'get_param_index_output_ctrl', (aksy.devices.akai.sysex_types.WORD,), None)
        self.get_number_of_parameters_cmd = Command('_', '\x24\x30', 'get_number_of_parameters', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_parameter_minimum_cmd = Command('_', '\x24\x31', 'get_parameter_minimum', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_parameter_maximum_cmd = Command('_', '\x24\x32', 'get_parameter_maximum', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_parameter_name_cmd = Command('_', '\x24\x33', 'get_parameter_name', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_parameter_units_cmd = Command('_', '\x24\x34', 'get_parameter_units', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_parameter_type_cmd = Command('_', '\x24\x35', 'get_parameter_type', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_display_template_cmd = Command('_', '\x24\x36', 'get_display_template', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_parameter_display_id_cmd = Command('_', '\x24\x38', 'get_parameter_display_id', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_number_of_parameter_groups_cmd = Command('_', '\x24\x40', 'get_number_of_parameter_groups', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_group_name_cmd = Command('_', '\x24\x41', 'get_group_name', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_group_index_of_parameter_cmd = Command('_', '\x24\x42', 'get_group_index_of_parameter', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        ...
        self.set_channel_input_cmd = Command('_', '\x26\x21', 'set_channel_input', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_channel_output_cmd = Command('_', '\x26\x22', 'set_channel_output', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_effect_by_name_cmd = Command('_', '\x26\x30', 'set_effect_by_name', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.STRING), None)
        self.set_effect_by_index_cmd = Command('_', '\x26\x31', 'set_effect_by_index', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.enable_fx_module_cmd = Command('_', '\x26\x40', 'enable_fx_module', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BOOL), None)
        self.set_parameter_value_cmd = Command('_', '\x26\x50', 'set_parameter_value', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.SDWORD), None)
        self.map_qlink_control_cmd = Command('_', '\x26\x52', 'map_qlink_control', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.is_channel_muted_cmd = Command('_', '\x27\x20', 'is_channel_muted', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_channel_input_cmd = Command('_', '\x27\x21', 'get_channel_input', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_channel_output_cmd = Command('_', '\x27\x22', 'get_channel_output', (aksy.devices.akai.sysex_types.BYTE,), None)
        ...
        self.set_channel_input_cmd = Command('_', '\x26\x21', 'set_channel_input', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_channel_output_cmd = Command('_', '\x26\x22', 'set_channel_output', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_fx_by_id_cmd = Command('_', '\x26\x30', 'set_fx_by_id', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.STRING), None)
        self.set_fx_by_name_cmd = Command('_', '\x26\x31', 'set_fx_by_name', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.enable_module_cmd = Command('_', '\x26\x40', 'enable_module', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BOOL), None)
        self.set_param_value_cmd = Command('_', '\x26\x50', 'set_param_value', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_param_qlinkctrl_cmd = Command('_', '\x26\x52', 'set_param_qlinkctrl', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
