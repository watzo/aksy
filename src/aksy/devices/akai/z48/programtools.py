...
class Programtools:
    def __init__(self, z48):
        self.sampler = z48
        self.get_no_items_cmd = Command(b'_', b'\x14\x01', 'programtools', 'get_no_items', (), None)
        self.get_handles_cmd = Command(b'_', b'\x14\x02\x00', 'programtools', 'get_handles', (), None)
        self.get_names_cmd = Command(b'_', b'\x14\x02\x01', 'programtools', 'get_names', (), None)
        self.get_handles_names_cmd = Command(b'_', b'\x14\x02\x02', 'programtools', 'get_handles_names', (), None)
        self.get_modified_cmd = Command(b'_', b'\x14\x02\x03', 'programtools', 'get_modified', (), None)
        self.set_curr_by_handle_cmd = Command(b'_', b'\x14\x03', 'programtools', 'set_curr_by_handle', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.set_curr_by_name_cmd = Command(b'_', b'\x14\x04', 'programtools', 'set_curr_by_name', (aksy.devices.akai.sysex_types.STRING,), None)
        self.get_curr_handle_cmd = Command(b'_', b'\x14\x05', 'programtools', 'get_curr_handle', (), None)
        self.get_curr_name_cmd = Command(b'_', b'\x14\x06', 'programtools', 'get_curr_name', (), None)
        self.get_name_by_handle_cmd = Command(b'_', b'\x14\x07', 'programtools', 'get_name_by_handle', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.get_handle_by_name_cmd = Command(b'_', b'\x14\x08', 'programtools', 'get_handle_by_name', (aksy.devices.akai.sysex_types.STRING,), None)
        self.delete_all_cmd = Command(b'_', b'\x14\x09', 'programtools', 'delete_all', (), None)
        self.delete_curr_cmd = Command(b'_', b'\x14\x0A', 'programtools', 'delete_curr', (), None)
        self.delete_by_handle_cmd = Command(b'_', b'\x14\x0B', 'programtools', 'delete_by_handle', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.rename_curr_cmd = Command(b'_', b'\x14\x0C', 'programtools', 'rename_curr', (aksy.devices.akai.sysex_types.STRING,), None)
        self.rename_by_handle_cmd = Command(b'_', b'\x14\x0D', 'programtools', 'rename_by_handle', (aksy.devices.akai.sysex_types.DWORD, aksy.devices.akai.sysex_types.STRING), None)
        self.tag_cmd = Command(b'_', b'\x14\x0E', 'programtools', 'tag', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_tag_bitmap_cmd = Command(b'_', b'\x14\x0F', 'programtools', 'get_tag_bitmap', (), None)
        self.get_modified_name_cmd = Command(b'_', b'\x14\x10', 'programtools', 'get_modified_name', (), None)
        self.get_modified_state_cmd = Command(b'_', b'\x14\x11', 'programtools', 'get_modified_state', (), None)
        self.delete_tagged_cmd = Command(b'_', b'\x14\x18', 'programtools', 'delete_tagged', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.create_new_cmd = Command(b'_', b'\x14\x40', 'programtools', 'create_new', (aksy.devices.akai.sysex_types.WORD, aksy.devices.akai.sysex_types.STRING), None)
        self.add_keygroups_cmd = Command(b'_', b'\x14\x41', 'programtools', 'add_keygroups', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.delete_keygroup_cmd = Command(b'_', b'\x14\x42', 'programtools', 'delete_keygroup', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.delete_blank_keygroups_cmd = Command(b'_', b'\x14\x43', 'programtools', 'delete_blank_keygroups', (), None)
        self.arrange_keygroups_cmd = Command(b'_', b'\x14\x44', 'programtools', 'arrange_keygroups', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.copy_keygroup_cmd = Command(b'_', b'\x14\x45', 'programtools', 'copy_keygroup', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.copy_cmd = Command(b'_', b'\x14\x48', 'programtools', 'copy', (aksy.devices.akai.sysex_types.STRING,), None)
        self.merge_programs_cmd = Command(b'_', b'\x14\x49', 'programtools', 'merge_programs', (aksy.devices.akai.sysex_types.DWORD, aksy.devices.akai.sysex_types.DWORD), None)
        self.add_keygroup_sample_cmd = Command(b'_', b'\x14\x4A', 'programtools', 'add_keygroup_sample', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BOOL, aksy.devices.akai.sysex_types.STRING), None)
        self.copy_temperament_to_user_cmd = Command(b'_', b'\x14\x50', 'programtools', 'copy_temperament_to_user', (), None)
        self.get_no_modulation_connections_cmd = Command(b'_', b'\x14\x54', 'programtools', 'get_no_modulation_connections', (), None)
        self.get_no_modulation_sources_cmd = Command(b'_', b'\x14\x55', 'programtools', 'get_no_modulation_sources', (), None)
        self.get_no_modulation_destinations_cmd = Command(b'_', b'\x14\x56', 'programtools', 'get_no_modulation_destinations', (), None)
        self.get_name_modulation_source_cmd = Command(b'_', b'\x14\x57', 'programtools', 'get_name_modulation_source', (aksy.devices.akai.sysex_types.WORD,), None)
        self.get_name_modulation_dest_cmd = Command(b'_', b'\x14\x58', 'programtools', 'get_name_modulation_dest', (aksy.devices.akai.sysex_types.WORD,), None)
        self.get_group_id_cmd = Command(b'_', b'\x17\x01', 'programtools', 'get_group_id', (), None)
        self.get_type_cmd = Command(b'_', b'\x17\x03', 'programtools', 'get_type', (), None)
        self.get_genre_cmd = Command(b'_', b'\x17\x04', 'programtools', 'get_genre', (), None)
        self.get_program_no_cmd = Command(b'_', b'\x17\x08', 'programtools', 'get_program_no', (), None)
        self.get_no_keygroups_cmd = Command(b'_', b'\x17\x09', 'programtools', 'get_no_keygroups', (), None)
        self.get_keygroup_xfade_cmd = Command(b'_', b'\x17\x0A', 'programtools', 'get_keygroup_xfade', (), None)
        self.get_keygroup_xfade_type_cmd = Command(b'_', b'\x17\x0B', 'programtools', 'get_keygroup_xfade_type', (), None)
        self.get_level_cmd = Command(b'_', b'\x17\x0C', 'programtools', 'get_level', (), None)
        self.get_polyphony_cmd = Command(b'_', b'\x17\x10', 'programtools', 'get_polyphony', (), None)
        self.get_reassignment_method_cmd = Command(b'_', b'\x17\x11', 'programtools', 'get_reassignment_method', (), None)
        self.get_softpedal_loudness_reduction_cmd = Command(b'_', b'\x17\x12', 'programtools', 'get_softpedal_loudness_reduction', (), None)
        self.get_softpedal_attack_stretch_cmd = Command(b'_', b'\x17\x13', 'programtools', 'get_softpedal_attack_stretch', (), None)
        self.get_softpedal_filter_close_cmd = Command(b'_', b'\x17\x14', 'programtools', 'get_softpedal_filter_close', (), None)
        self.get_midi_transpose_cmd = Command(b'_', b'\x17\x15', 'programtools', 'get_midi_transpose', (), None)
        self.get_mpc_pad_assignment_cmd = Command(b'_', b'\x17\x18', 'programtools', 'get_mpc_pad_assignment', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_modulation_connection_cmd = Command(b'_', b'\x17\x20', 'programtools', 'get_modulation_connection', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.get_modulation_source_type_cmd = Command(b'_', b'\x17\x21', 'programtools', 'get_modulation_source_type', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_modulation_destination_type_cmd = Command(b'_', b'\x17\x22', 'programtools', 'get_modulation_destination_type', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_modulation_level_cmd = Command(b'_', b'\x17\x23', 'programtools', 'get_modulation_level', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.get_midi_controller_number_cmd = Command(b'_', b'\x17\x24', 'programtools', 'get_midi_controller_number', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_edit_keygroup_cmd = Command(b'_', b'\x17\x25', 'programtools', 'get_edit_keygroup', (), None)
        self.get_modulation_level_edit_keygroup_cmd = Command(b'_', b'\x17\x26', 'programtools', 'get_modulation_level_edit_keygroup', (), None)
        self.get_tune_cmd = Command(b'_', b'\x17\x30', 'programtools', 'get_tune', (), None)
        self.get_temperament_template_cmd = Command(b'_', b'\x17\x31', 'programtools', 'get_temperament_template', (), None)
        self.get_program_temperament_cmd = Command(b'_', b'\x17\x32', 'programtools', 'get_program_temperament', (), None)
        self.get_key_cmd = Command(b'_', b'\x17\x33', 'programtools', 'get_key', (), None)
        self.get_user_temperament_note_cmd = Command(b'_', b'\x17\x34', 'programtools', 'get_user_temperament_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_pitchbend_up_cmd = Command(b'_', b'\x17\x40', 'programtools', 'get_pitchbend_up', (), None)
        self.get_pitchbend_down_cmd = Command(b'_', b'\x17\x41', 'programtools', 'get_pitchbend_down', (), None)
        self.get_pitchbend_mode_cmd = Command(b'_', b'\x17\x42', 'programtools', 'get_pitchbend_mode', (), None)
        self.get_aftertouch_value_cmd = Command(b'_', b'\x17\x43', 'programtools', 'get_aftertouch_value', (), None)
        self.get_legato_cmd = Command(b'_', b'\x17\x44', 'programtools', 'get_legato', (), None)
        self.get_portamento_enabled_cmd = Command(b'_', b'\x17\x45', 'programtools', 'get_portamento_enabled', (), None)
        self.get_portamento_mode_cmd = Command(b'_', b'\x17\x46', 'programtools', 'get_portamento_mode', (), None)
        self.get_portamento_time_cmd = Command(b'_', b'\x17\x47', 'programtools', 'get_portamento_time', (), None)
        self.get_glissando_mode_cmd = Command(b'_', b'\x17\x48', 'programtools', 'get_glissando_mode', (), None)
        self.get_aftertouch_mode_cmd = Command(b'_', b'\x17\x49', 'programtools', 'get_aftertouch_mode', (), None)
        self.set_group_id_cmd = Command(b'_', b'\x16\x01', 'programtools', 'set_group_id', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_type_cmd = Command(b'_', b'\x16\x03', 'programtools', 'set_type', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_genre_cmd = Command(b'_', b'\x16\x04', 'programtools', 'set_genre', (aksy.devices.akai.sysex_types.STRING,), None)
        self.set_program_no_cmd = Command(b'_', b'\x16\x08', 'programtools', 'set_program_no', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_no_keygroups_cmd = Command(b'_', b'\x16\x09', 'programtools', 'set_no_keygroups', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_keygroup_xfade_cmd = Command(b'_', b'\x16\x0A', 'programtools', 'set_keygroup_xfade', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_keygroup_xfade_type_cmd = Command(b'_', b'\x16\x0B', 'programtools', 'set_keygroup_xfade_type', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_level_cmd = Command(b'_', b'\x16\x0C', 'programtools', 'set_level', (aksy.devices.akai.sysex_types.SWORD,), None)
        self.set_polyphony_cmd = Command(b'_', b'\x16\x10', 'programtools', 'set_polyphony', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_reassignment_method_cmd = Command(b'_', b'\x16\x11', 'programtools', 'set_reassignment_method', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_softpedal_loudness_reduction_cmd = Command(b'_', b'\x16\x12', 'programtools', 'set_softpedal_loudness_reduction', (), None)
        self.set_softpedal_attack_stretch_cmd = Command(b'_', b'\x16\x13', 'programtools', 'set_softpedal_attack_stretch', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_softpedal_filter_close_cmd = Command(b'_', b'\x16\x14', 'programtools', 'set_softpedal_filter_close', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_midi_transpose_cmd = Command(b'_', b'\x16\x15', 'programtools', 'set_midi_transpose', (aksy.devices.akai.sysex_types.SBYTE,), None)
        self.set_mpc_pad_assignment_cmd = Command(b'_', b'\x16\x18', 'programtools', 'set_mpc_pad_assignment', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_modulation_connection_cmd = Command(b'_', b'\x16\x20', 'programtools', 'set_modulation_connection', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD, aksy.devices.akai.sysex_types.WORD, aksy.devices.akai.sysex_types.WORD, aksy.devices.akai.sysex_types.SBYTE), None)
        self.set_modulation_source_cmd = Command(b'_', b'\x16\x21', 'programtools', 'set_modulation_source', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.set_modulation_destination_cmd = Command(b'_', b'\x16\x22', 'programtools', 'set_modulation_destination', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.set_modulation_level_cmd = Command(b'_', b'\x16\x23', 'programtools', 'set_modulation_level', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD, aksy.devices.akai.sysex_types.SBYTE), None)
        self.set_midi_ctrl_no_cmd = Command(b'_', b'\x16\x24', 'programtools', 'set_midi_ctrl_no', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_edit_keygroup_cmd = Command(b'_', b'\x16\x25', 'programtools', 'set_edit_keygroup', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.WORD), None)
        self.set_edit_kegyroup_modulation_level_cmd = Command(b'_', b'\x16\x26', 'programtools', 'set_edit_kegyroup_modulation_level', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.set_tune_cmd = Command(b'_', b'\x16\x30', 'programtools', 'set_tune', (aksy.devices.akai.sysex_types.TUNE,), None)
        self.set_temperament_template_cmd = Command(b'_', b'\x16\x31', 'programtools', 'set_temperament_template', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_program_temperament_cmd = Command(b'_', b'\x16\x32', 'programtools', 'set_program_temperament', (aksy.devices.akai.sysex_types.SBYTE,), None)
        self.set_key_cmd = Command(b'_', b'\x16\x33', 'programtools', 'set_key', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_user_temperament_note_cmd = Command(b'_', b'\x16\x34', 'programtools', 'set_user_temperament_note', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.SBYTE), None)
        self.set_pitchbend_up_cmd = Command(b'_', b'\x16\x40', 'programtools', 'set_pitchbend_up', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_pitchbend_down_cmd = Command(b'_', b'\x16\x41', 'programtools', 'set_pitchbend_down', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_pitchbend_mode_cmd = Command(b'_', b'\x16\x42', 'programtools', 'set_pitchbend_mode', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_aftertouch_value_cmd = Command(b'_', b'\x16\x43', 'programtools', 'set_aftertouch_value', (aksy.devices.akai.sysex_types.SBYTE,), None)
        self.set_legato_cmd = Command(b'_', b'\x16\x44', 'programtools', 'set_legato', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_portamento_enabled_cmd = Command(b'_', b'\x16\x45', 'programtools', 'set_portamento_enabled', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_portamento_mode_cmd = Command(b'_', b'\x16\x46', 'programtools', 'set_portamento_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_portamento_time_cmd = Command(b'_', b'\x16\x47', 'programtools', 'set_portamento_time', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_glissando_mode_cmd = Command(b'_', b'\x16\x48', 'programtools', 'set_glissando_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_aftertouch_mode_cmd = Command(b'_', b'\x16\x49', 'programtools', 'set_aftertouch_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
