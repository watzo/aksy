...
class Recordingtools:
    def __init__(self, z48):
        self.sampler = z48
        self.get_status_cmd = Command('_', '\x30\x01', 'get_status', (), None)
        self.get_progress_cmd = Command('_', '\x30\x02', 'get_progress', (), None)
        self.get_max_rec_time_cmd = Command('_', '\x30\x03', 'get_max_rec_time', (), None)
        self.arm_cmd = Command('_', '\x30\x10', 'arm', (), None)
        self.start_cmd = Command('_', '\x30\x11', 'start', (), None)
        self.stop_cmd = Command('_', '\x30\x12', 'stop', (), None)
        self.cancel_cmd = Command('_', '\x30\x13', 'cancel', (), None)
        self.start_playing_cmd = Command('_', '\x30\x20', 'start_playing', (), None)
        self.stop_playing_cmd = Command('_', '\x30\x21', 'stop_playing', (), None)
        self.keep_cmd = Command('_', '\x30\x22', 'keep', (), None)
        self.delete_cmd = Command('_', '\x30\x23', 'delete', (), None)
        self.set_input_cmd = Command('_', '\x32\x01', 'set_input', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_mode_cmd = Command('_', '\x32\x02', 'set_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.enable_monitor_cmd = Command('_', '\x32\x03', 'enable_monitor', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_rec_time_cmd = Command('_', '\x32\x04', 'set_rec_time', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.set_orig_pitch_cmd = Command('_', '\x32\x05', 'set_orig_pitch', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_threshold_cmd = Command('_', '\x32\x06', 'set_threshold', (aksy.devices.akai.sysex_types.SBYTE,), None)
        self.set_trigger_src_cmd = Command('_', '\x32\x07', 'set_trigger_src', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_bit_depth_cmd = Command('_', '\x32\x08', 'set_bit_depth', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_prerec_time_cmd = Command('_', '\x32\x09', 'set_prerec_time', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_dest_cmd = Command('_', '\x32\x0A', 'set_dest', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_name_cmd = Command('_', '\x32\x10', 'set_name', (aksy.devices.akai.sysex_types.STRING,), None)
        self.set_name_seed_cmd = Command('_', '\x32\x11', 'set_name_seed', (aksy.devices.akai.sysex_types.STRING,), None)
        self.set_autorec_mode_cmd = Command('_', '\x32\x12', 'set_autorec_mode', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_autonormalize_cmd = Command('_', '\x32\x13', 'set_autonormalize', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.get_input_cmd = Command('_', '\x33\x01', 'get_input', (), None)
        self.get_mode_cmd = Command('_', '\x33\x02', 'get_mode', (), None)
        self.get_monitor_cmd = Command('_', '\x33\x03', 'get_monitor', (), None)
        self.get_rec_time_cmd = Command('_', '\x33\x04', 'get_rec_time', (), None)
        self.get_pitch_cmd = Command('_', '\x33\x05', 'get_pitch', (), None)
        self.get_threshold_cmd = Command('_', '\x33\x06', 'get_threshold', (), None)
        self.get_trigger_src_cmd = Command('_', '\x33\x07', 'get_trigger_src', (), None)
        self.get_bit_depth_cmd = Command('_', '\x33\x08', 'get_bit_depth', (), None)
        self.get_prerec_time_cmd = Command('_', '\x33\x09', 'get_prerec_time', (), None)
        self.get_dest_cmd = Command('_', '\x33\x0A', 'get_dest', (), None)
        self.get_name_cmd = Command('_', '\x33\x10', 'get_name', (), None)
        self.get_name_seed_cmd = Command('_', '\x33\x11', 'get_name_seed', (), None)
        self.get_autorec_mode_cmd = Command('_', '\x33\x12', 'get_autorec_mode', (), None)
        self.get_autonormalize_cmd = Command('_', '\x33\x13', 'get_autonormalize', (), None)
