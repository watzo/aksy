...
class Recordingtools:
    def __init__(self, z48):
        self.sampler = z48
        self.get_status_cmd = Command(b'_', b'\x30\x01', 'recordingtools', 'get_status', (), None)
        self.get_progress_cmd = Command(b'_', b'\x30\x02', 'recordingtools', 'get_progress', (), None)
        self.get_max_rec_time_cmd = Command(b'_', b'\x30\x03', 'recordingtools', 'get_max_rec_time', (), None)
        self.arm_cmd = Command(b'_', b'\x30\x10', 'recordingtools', 'arm', (), None)
        self.start_cmd = Command(b'_', b'\x30\x11', 'recordingtools', 'start', (), None)
        self.stop_cmd = Command(b'_', b'\x30\x12', 'recordingtools', 'stop', (), None)
        self.cancel_cmd = Command(b'_', b'\x30\x13', 'recordingtools', 'cancel', (), None)
        self.start_playing_cmd = Command(b'_', b'\x30\x20', 'recordingtools', 'start_playing', (), None)
        self.stop_playing_cmd = Command(b'_', b'\x30\x21', 'recordingtools', 'stop_playing', (), None)
        self.keep_cmd = Command(b'_', b'\x30\x22', 'recordingtools', 'keep', (), None)
        self.delete_cmd = Command(b'_', b'\x30\x23', 'recordingtools', 'delete', (), None)
        self.set_input_cmd = Command(b'_', b'\x32\x01', 'recordingtools', 'set_input', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_mode_cmd = Command(b'_', b'\x32\x02', 'recordingtools', 'set_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.enable_monitor_cmd = Command(b'_', b'\x32\x03', 'recordingtools', 'enable_monitor', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_rec_time_cmd = Command(b'_', b'\x32\x04', 'recordingtools', 'set_rec_time', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.set_orig_pitch_cmd = Command(b'_', b'\x32\x05', 'recordingtools', 'set_orig_pitch', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_threshold_cmd = Command(b'_', b'\x32\x06', 'recordingtools', 'set_threshold', (aksy.devices.akai.sysex_types.SBYTE,), None)
        self.set_trigger_src_cmd = Command(b'_', b'\x32\x07', 'recordingtools', 'set_trigger_src', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_bit_depth_cmd = Command(b'_', b'\x32\x08', 'recordingtools', 'set_bit_depth', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_prerec_time_cmd = Command(b'_', b'\x32\x09', 'recordingtools', 'set_prerec_time', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_dest_cmd = Command(b'_', b'\x32\x0A', 'recordingtools', 'set_dest', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_name_cmd = Command(b'_', b'\x32\x10', 'recordingtools', 'set_name', (aksy.devices.akai.sysex_types.STRING,), None)
        self.set_name_seed_cmd = Command(b'_', b'\x32\x11', 'recordingtools', 'set_name_seed', (aksy.devices.akai.sysex_types.STRING,), None)
        self.set_autorec_mode_cmd = Command(b'_', b'\x32\x12', 'recordingtools', 'set_autorec_mode', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.set_autonormalize_cmd = Command(b'_', b'\x32\x13', 'recordingtools', 'set_autonormalize', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.get_input_cmd = Command(b'_', b'\x33\x01', 'recordingtools', 'get_input', (), None)
        self.get_mode_cmd = Command(b'_', b'\x33\x02', 'recordingtools', 'get_mode', (), None)
        self.get_monitor_cmd = Command(b'_', b'\x33\x03', 'recordingtools', 'get_monitor', (), None)
        self.get_rec_time_cmd = Command(b'_', b'\x33\x04', 'recordingtools', 'get_rec_time', (), None)
        self.get_pitch_cmd = Command(b'_', b'\x33\x05', 'recordingtools', 'get_pitch', (), None)
        self.get_threshold_cmd = Command(b'_', b'\x33\x06', 'recordingtools', 'get_threshold', (), None)
        self.get_trigger_src_cmd = Command(b'_', b'\x33\x07', 'recordingtools', 'get_trigger_src', (), None)
        self.get_bit_depth_cmd = Command(b'_', b'\x33\x08', 'recordingtools', 'get_bit_depth', (), None)
        self.get_prerec_time_cmd = Command(b'_', b'\x33\x09', 'recordingtools', 'get_prerec_time', (), None)
        self.get_dest_cmd = Command(b'_', b'\x33\x0A', 'recordingtools', 'get_dest', (), None)
        self.get_name_cmd = Command(b'_', b'\x33\x10', 'recordingtools', 'get_name', (), None)
        self.get_name_seed_cmd = Command(b'_', b'\x33\x11', 'recordingtools', 'get_name_seed', (), None)
        self.get_autorec_mode_cmd = Command(b'_', b'\x33\x12', 'recordingtools', 'get_autorec_mode', (), None)
        self.get_autonormalize_cmd = Command(b'_', b'\x33\x13', 'recordingtools', 'get_autonormalize', (), None)
