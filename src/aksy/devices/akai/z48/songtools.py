...
class Songtools:
    def __init__(self, z48):
        self.sampler = z48
        self.get_no_items_cmd = Command(b'_', b'\x28\x01', 'songtools', 'get_no_items', (), None)
        self.get_handles_cmd = Command(b'_', b'\x28\x02\x00', 'songtools', 'get_handles', (), None)
        self.get_names_cmd = Command(b'_', b'\x28\x02\x01', 'songtools', 'get_names', (), None)
        self.get_handles_names_cmd = Command(b'_', b'\x28\x02\x02', 'songtools', 'get_handles_names', (), None)
        self.get_handles_modified_cmd = Command(b'_', b'\x28\x02\x03', 'songtools', 'get_handles_modified', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_curr_by_handle_cmd = Command(b'_', b'\x28\x03', 'songtools', 'set_curr_by_handle', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.set_curr_by_name_cmd = Command(b'_', b'\x28\x04', 'songtools', 'set_curr_by_name', (aksy.devices.akai.sysex_types.STRING,), None)
        self.get_curr_handle_cmd = Command(b'_', b'\x28\x05', 'songtools', 'get_curr_handle', (), None)
        self.get_curr_name_cmd = Command(b'_', b'\x28\x06', 'songtools', 'get_curr_name', (), None)
        self.get_name_by_handle_cmd = Command(b'_', b'\x28\x07', 'songtools', 'get_name_by_handle', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.get_handle_by_name_cmd = Command(b'_', b'\x28\x08', 'songtools', 'get_handle_by_name', (aksy.devices.akai.sysex_types.STRING,), None)
        self.delete_all_cmd = Command(b'_', b'\x28\x09', 'songtools', 'delete_all', (), None)
        self.delete_curr_cmd = Command(b'_', b'\x28\x0A', 'songtools', 'delete_curr', (), None)
        self.delete_by_handle_cmd = Command(b'_', b'\x28\x0B', 'songtools', 'delete_by_handle', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.rename_curr_cmd = Command(b'_', b'\x28\x0C', 'songtools', 'rename_curr', (aksy.devices.akai.sysex_types.STRING,), None)
        self.rename_by_handle_cmd = Command(b'_', b'\x28\x0D', 'songtools', 'rename_by_handle', (aksy.devices.akai.sysex_types.DWORD, aksy.devices.akai.sysex_types.STRING), None)
        self.set_tag_bit_cmd = Command(b'_', b'\x28\x0E', 'songtools', 'set_tag_bit', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), None)
        self.get_tag_bitmap_cmd = Command(b'_', b'\x28\x0F', 'songtools', 'get_tag_bitmap', (), None)
        self.get_curr_modified_cmd = Command(b'_', b'\x28\x10', 'songtools', 'get_curr_modified', (), None)
        self.get_modified_cmd = Command(b'_', b'\x28\x11', 'songtools', 'get_modified', (), None)
        self.delete_tagged_cmd = Command(b'_', b'\x28\x18', 'songtools', 'delete_tagged', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.play_song_cmd = Command(b'_', b'\x28\x40', 'songtools', 'play_song', (), None)
        self.pause_song_cmd = Command(b'_', b'\x28\x41', 'songtools', 'pause_song', (), None)
        self.stop_song_cmd = Command(b'_', b'\x28\x42', 'songtools', 'stop_song', (), None)
        self.set_group_id_cmd = Command(b'_', b'\x28\x01', 'songtools', 'set_group_id', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_from_bar_cmd = Command(b'_', b'\x28\x10', 'songtools', 'set_from_bar', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_to_bar_cmd = Command(b'_', b'\x28\x10', 'songtools', 'set_to_bar', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_tempo_mode_cmd = Command(b'_', b'\x28\x12', 'songtools', 'set_tempo_mode', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_manual_tempo_cmd = Command(b'_', b'\x28\x13', 'songtools', 'set_manual_tempo', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_midi_output_cmd = Command(b'_', b'\x28\x18', 'songtools', 'set_midi_output', (aksy.devices.akai.sysex_types.BOOL,), None)
        self.get_group_id_cmd = Command(b'_', b'\x28\x01', 'songtools', 'get_group_id', (), None)
        self.get_from_bar_cmd = Command(b'_', b'\x28\x10', 'songtools', 'get_from_bar', (), None)
        self.get_to_bar_cmd = Command(b'_', b'\x28\x11', 'songtools', 'get_to_bar', (), None)
        self.get_tempo_mode_cmd = Command(b'_', b'\x28\x12', 'songtools', 'get_tempo_mode', (), None)
        self.get_manual_tempo_cmd = Command(b'_', b'\x28\x13', 'songtools', 'get_manual_tempo', (), None)
        self.get_midi_output_port_cmd = Command(b'_', b'\x28\x18', 'songtools', 'get_midi_output_port', (), None)
        self.get_time_signature_beat_cmd = Command(b'_', b'\x28\x20', 'songtools', 'get_time_signature_beat', (), None)
        self.get_time_sig_beat_no_cmd = Command(b'_', b'\x28\x21', 'songtools', 'get_time_sig_beat_no', (), None)
        self.get_curr_beat_cmd = Command(b'_', b'\x28\x22', 'songtools', 'get_curr_beat', (), None)
        self.get_curr_bar_cmd = Command(b'_', b'\x28\x23', 'songtools', 'get_curr_bar', (), None)
        self.get_curr_tempo_cmd = Command(b'_', b'\x28\x24', 'songtools', 'get_curr_tempo', (), None)
