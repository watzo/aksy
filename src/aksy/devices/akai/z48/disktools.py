...
class Disktools:
     def __init__(self, z48):
          ...
          self.select_disk_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x02', 'select_disk', (aksy.devices.akai.sysex_types.WORD,), None)
          ...
          self.get_no_subfolders_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x10', 'get_no_subfolders', (), None)
          self.get_subfolder_names_cmd = aksy.devices.akai.sysex.Command('\x5e', '\x10\x12', 'get_subfolder_names', (),
              (aksy.devices.akai.sysex_types.STRINGARRAY,), userref_type=aksy.devices.akai.sysex_types.S56K_USERREF)
          self.set_curr_folder_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x13', 'set_curr_folder', (aksy.devices.akai.sysex_types.STRING,), None)
          ...
          self.create_subfolder_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x16', 'create_subfolder', (aksy.devices.akai.sysex_types.STRING,), None)
          self.del_subfolder_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x17', 'del_subfolder', (aksy.devices.akai.sysex_types.STRING,), None)
          self.rename_subfolder_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x18', 'rename_subfolder', (aksy.devices.akai.sysex_types.STRING, aksy.devices.akai.sysex_types.STRING), None)
          ...
          self.get_filenames_cmd = aksy.devices.akai.sysex.Command('\x5e', '\x10\x22', 'get_filenames', (),
              (aksy.devices.akai.sysex_types.STRINGARRAY,), userref_type=aksy.devices.akai.sysex_types.S56K_USERREF)
          self.rename_file_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x28', 'rename_file', (aksy.devices.akai.sysex_types.STRING, aksy.devices.akai.sysex_types.STRING), None)
          self.delete_file_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x29', 'delete_file', (aksy.devices.akai.sysex_types.STRING,), None)
          self.load_file_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x2A', 'load_file', (aksy.devices.akai.sysex_types.STRING,), None)
          ...
          self.save_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x2C', 'save', (aksy.devices.akai.sysex_types.DWORD, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BOOL, aksy.devices.akai.sysex_types.BYTE), None)
          self.save_all_cmd = aksy.devices.akai.sysex.Command('\x5f', '\x20\x2D', 'save_all', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BOOL), None)
