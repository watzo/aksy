...
class Multitools:
    def __init__(self, z48):
        self.z48 = z48
        self.get_no_items_cmd = aksy.devices.akai.sysex.Command('_', '\x18\x01', 'get_no_items', (), None)
        self.get_handles_cmd = aksy.devices.akai.sysex.Command('_', '\x18\x02\x00', 'get_handles', (), None)
        ...
        self.get_multi_tempo_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x04', 'get_multi_tempo', (), None)
        self.get_multi_program_no_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x08', 'get_multi_program_no', (), None)
        self.get_multi_part_handle_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x09', 'get_multi_part_handle', (aksy.devices.akai.sysex_types.DWORD,), None)
        self.get_multi_part_name_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x0A', 'get_multi_part_name', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_no_parts_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x0F', 'get_no_parts', (), None)
        self.get_part_midi_channel_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x10', 'get_part_midi_channel', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_mute_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x11', 'get_part_mute', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_solo_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x12', 'get_part_solo', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_level_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x13', 'get_part_level', (), None)
        self.get_part_output_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x14', 'get_part_output', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_pan_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x15', 'get_part_pan', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_fx_channel_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x16', 'get_part_fx_channel', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_fx_send_level_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x17', 'get_part_fx_send_level', (), None)
        self.get_part_tune_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x18', 'get_part_tune', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_low_note_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x1A', 'get_part_low_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.get_part_high_note_cmd = aksy.devices.akai.sysex.Command('_', '\x1B\x1B', 'get_part_high_note', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_group_id_cmd = aksy.devices.akai.sysex.Command('_', '\x1A\x01', 'set_group_id', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_multi_select_method_cmd = aksy.devices.akai.sysex.Command('_', '\x1A\x02', 'set_multi_select_method', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_multi_select_channel_cmd = aksy.devices.akai.sysex.Command('_', '\x1A\x03', 'set_multi_select_channel', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_multi_tempo_cmd = aksy.devices.akai.sysex.Command('_', '\x1A\x04', 'set_multi_tempo', (aksy.devices.akai.sysex_types.WORD,), None)
        self.set_multi_program_no_cmd = aksy.devices.akai.sysex.Command('_', '\x1A\x08', 'set_multi_program_no', (aksy.devices.akai.sysex_types.BYTE,), None)
        self.set_multi_part_by_handle_cmd = aksy.devices.akai.sysex.Command('_', '\x1A\x09', 'set_multi_part_by_handle', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.DWORD), None)
