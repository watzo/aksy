...
class Sysextools:
     def __init__(self, s56k):
          self.s56k = s56k
          self.commands = {}
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x00', 'query', (), ())
          self.commands['\x00\x00'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x01', 'enable_msg_notification', (aksy.devices.akai.sysex_types.BOOL,), ())
          self.commands['\x00\x01'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x03', 'enable_item_sync', (aksy.devices.akai.sysex_types.BOOL,), ())
          self.commands['\x00\x03'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x04', 'enable_checksum_verification', (aksy.devices.akai.sysex_types.BOOL,), ())
          self.commands['\x00\x04'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x05', 'enable_screen_updates', (aksy.devices.akai.sysex_types.BOOL,), ())
          self.commands['\x00\x05'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x06', 'echo', (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE), (aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE, aksy.devices.akai.sysex_types.BYTE))
          self.commands['\x00\x06'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x07', 'enable_heartbeat', (), ())
          self.commands['\x00\x07'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x08', 'enable_playback_sync', (aksy.devices.akai.sysex_types.BOOL,), ())
          self.commands['\x00\x08'] = comm
          comm = aksy.devices.akai.sysex.Command('^', '\x00\x10', 'get_sysex_buffersize', (), (aksy.devices.akai.sysex_types.WORD,))
