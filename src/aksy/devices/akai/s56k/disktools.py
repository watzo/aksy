...
class Disktools:
    def __init__(self, s56k):
        ...
        self.select_disk_cmd = Command('^', '\x10\x02', 'disktools', 'select_disk', (aksy.devices.akai.sysex_types.WORD,), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        self.test_disk_cmd = Command('^', '\x10\x03', 'disktools', 'test_disk', (aksy.devices.akai.sysex_types.WORD,), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        self.get_no_disks_cmd = Command('^', '\x10\x04', 'disktools', 'get_no_disks', (), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        self.get_disklist_cmd = Command('^', '\x10\x05', 'disktools', 'get_disklist', (), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        self.get_curr_path_cmd = Command('^', '\x10\x09', 'disktools', 'get_curr_path', (), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        ...
        self.get_no_folders_cmd = Command('^', '\x10\x10', 'disktools', 'get_no_folders', (), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        self.get_folder_names_cmd = Command('^', '\x10\x12', 'disktools', 'get_folder_names', (), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        ...
        self.get_no_files_cmd = Command('^', '\x10\x20', 'disktools', 'get_no_files', (), (), aksy.devices.akai.sysex_types.S56K_USERREF)
        self.get_filenames_cmd = Command('^', '\x10\x22', 'disktools', 'get_filenames', (), (), aksy.devices.akai.sysex_types.S56K_USERREF)
