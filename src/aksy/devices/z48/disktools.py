...
class Disktools:
     def __init__(self, z48):
          self.z48 = z48
          self.commands = {}
          comm = aksy.devices.z48.sysex.Command('\x10\x01', 'update_disklist', (), ())
          self.commands['\x10\x01'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x02', 'select_disk', (aksy.devices.z48.sysex.WORD,), ())
          self.commands['\x10\x02'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x03', 'test_disk', (aksy.devices.z48.sysex.WORD,), ())
          self.commands['\x10\x03'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x04', 'get_no_disks', (), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x10\x04'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x05', 'get_disklist', (), (aksy.devices.z48.sysex.WORD, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.STRING))
          self.commands['\x10\x05'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x09', 'get_curr_path', (), (aksy.devices.z48.sysex.STRING,))
          self.commands['\x10\x09'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x0D', 'eject_disk', (aksy.devices.z48.sysex.WORD,), ())
          self.commands['\x10\x0D'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x10', 'get_no_subfolders', (), (aksy.devices.z48.sysex.WORD,))
          self.commands['\x10\x10'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x12', 'get_subfolder_names', (), (aksy.devices.z48.sysex.STRING,))
          self.commands['\x10\x12'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x13', 'set_curr_folder', (aksy.devices.z48.sysex.STRING,), ())
          self.commands['\x10\x13'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x15', 'load_folder', (aksy.devices.z48.sysex.STRING,), ())
          self.commands['\x10\x15'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x16', 'create_subfolder', (aksy.devices.z48.sysex.STRING,), ())
          self.commands['\x10\x16'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x17', 'delete_subfolder', (aksy.devices.z48.sysex.STRING,), ())
          self.commands['\x10\x17'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x18', 'rename_subfolder', (aksy.devices.z48.sysex.STRING, aksy.devices.z48.sysex.STRING), ())
          self.commands['\x10\x18'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x20', 'get_no_files', (), (aksy.devices.z48.sysex.WORD,))
          self.commands['\x10\x20'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x22', 'get_filenames', (), (aksy.devices.z48.sysex.STRING,))
          self.commands['\x10\x22'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x28', 'rename_file', (aksy.devices.z48.sysex.STRING, aksy.devices.z48.sysex.STRING), ())
          self.commands['\x10\x28'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x29', 'delete_file', (aksy.devices.z48.sysex.STRING,), ())
          self.commands['\x10\x29'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x2A', 'load_file', (aksy.devices.z48.sysex.STRING,), ())
          self.commands['\x10\x2A'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x2B', 'load_file_and_deps', (aksy.devices.z48.sysex.STRING,), ())
          self.commands['\x10\x2B'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x2C', 'save', (aksy.devices.z48.sysex.DWORD, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BOOL, aksy.devices.z48.sysex.BYTE), ())
          self.commands['\x10\x2C'] = comm
          comm = aksy.devices.z48.sysex.Command('\x10\x2D', 'save_all', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BOOL), ())
