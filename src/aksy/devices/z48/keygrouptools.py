...
class Keygrouptools:
     def __init__(self, z48):
          ...
          comm = aksy.sysex.Command('\x13\x01', 'get_group_id', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x01'] = comm
          comm = aksy.sysex.Command('\x13\x02', 'get_edit_mode', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x02'] = comm
          comm = aksy.sysex.Command('\x13\x04', 'get_low_note', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x04'] = comm
          comm = aksy.sysex.Command('\x13\x05', 'get_high_note', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x05'] = comm
          comm = aksy.sysex.Command('\x13\x06', 'get_mute_group', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x06'] = comm
          comm = aksy.sysex.Command('\x13\x07 ', 'get_FX_override', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x07 '] = comm
          comm = aksy.sysex.Command('\x13\x08', 'get_FX_send_level', (), (aksy.sysex.SWORD,))
          self.commands['\x13\x08'] = comm
          comm = aksy.sysex.Command('\x13\x09', 'get_zone_crossfade', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x09'] = comm
          comm = aksy.sysex.Command('\x13\x0A', 'get_crossfade_type', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x0A'] = comm
          comm = aksy.sysex.Command('\x13\x0E', 'get_polyphoy', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x0E'] = comm
          comm = aksy.sysex.Command('\x13\x0F', 'get_zone_crossfade_ctrl_no', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x0F'] = comm
          comm = aksy.sysex.Command('\x13\x10', 'get_tune', (), (aksy.sysex.SBYTE,))
          self.commands['\x13\x10'] = comm
          comm = aksy.sysex.Command('\x13\x11 ', 'get_keygroup_level', (), (aksy.sysex.SWORD,))
          self.commands['\x13\x11 '] = comm
          comm = aksy.sysex.Command('\x13\x18', 'get_play_trigger', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x18'] = comm
          comm = aksy.sysex.Command('\x13\x19', 'get_player_trigger_velocity', (), (aksy.sysex.WORD,))
          self.commands['\x13\x19'] = comm
          comm = aksy.sysex.Command('\x13\x1A ', 'get_play_toggle_note', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x1A '] = comm
          comm = aksy.sysex.Command('\x13\x20', 'get_filter', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x20'] = comm
          comm = aksy.sysex.Command('\x13\x21', 'get_filter_cutoff', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x21'] = comm
          comm = aksy.sysex.Command('\x13\x22', 'get_filter_resonance', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x22'] = comm
          comm = aksy.sysex.Command('\x13\x23', 'get_filter_attenuation', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x23'] = comm
          comm = aksy.sysex.Command('\x13\x30', 'get_envelope_rate', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x30'] = comm
          comm = aksy.sysex.Command('\x13\x31', 'get_envelope_level1', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x31'] = comm
          comm = aksy.sysex.Command('\x13\x32', 'get_envelope_rate2', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x32'] = comm
          comm = aksy.sysex.Command('\x13\x33', 'get_envelope_level2', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x33'] = comm
          comm = aksy.sysex.Command('\x13\x34', 'get_envelope_rate3', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x34'] = comm
          comm = aksy.sysex.Command('\x13\x35', 'get_envelope_level3', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x35'] = comm
          comm = aksy.sysex.Command('\x13\x36', 'get_envelope_rate4', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x36'] = comm
          comm = aksy.sysex.Command('\x13\x37', 'get_envelope_level4', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x37'] = comm
          comm = aksy.sysex.Command('\x13\x42', 'get_envelope_reference', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x42'] = comm
          comm = aksy.sysex.Command('\x13\x43 ', 'get_attack_hold', (), (aksy.sysex.BYTE,))
          self.commands['\x13\x43 '] = comm
          comm = aksy.sysex.Command('\x13\x50', 'get_lfo_rate', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x50'] = comm
          comm = aksy.sysex.Command('\x13\x51 ', 'get_lfo_delay', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x51 '] = comm
          comm = aksy.sysex.Command('\x13\x52 ', 'get_lfo_depth', (aksy.sysex.BYTE, aksy.sysex.BYTE), (aksy.sysex.BYTE,))
          self.commands['\x13\x52 '] = comm
          comm = aksy.sysex.Command('\x13\x53', 'get_lfo_waveform', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x53'] = comm
          comm = aksy.sysex.Command('\x13\x54 ', 'get_lfo_phase', (aksy.sysex.BYTE,), (aksy.sysex.WORD,))
          self.commands['\x13\x54 '] = comm
          comm = aksy.sysex.Command('\x13\x55', 'get_LFO_shift', (aksy.sysex.BYTE,), (aksy.sysex.SBYTE,))
          self.commands['\x13\x55'] = comm
          comm = aksy.sysex.Command('\x13\x56', 'get_LFO_midi_sync', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x56'] = comm
          comm = aksy.sysex.Command('\x13\x57', 'get_midi_clock_sync_div', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x57'] = comm
          comm = aksy.sysex.Command('\x13\x58 ', 'get_LFO_retrigger', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x58 '] = comm
          comm = aksy.sysex.Command('\x13\x59', 'get_LFO_sync', (aksy.sysex.BYTE,), (aksy.sysex.BYTE,))
          self.commands['\x13\x59'] = comm
          comm = aksy.sysex.Command('\x12\x01', 'set_group_id', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x01'] = comm
          comm = aksy.sysex.Command('\x12\x02', 'set_edit_mode', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x02'] = comm
          comm = aksy.sysex.Command('\x12\x04', 'set_low_note', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x04'] = comm
          comm = aksy.sysex.Command('\x12\x05', 'set_high_note', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x05'] = comm
          comm = aksy.sysex.Command('\x12\x06', 'set_mute_group', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x06'] = comm
          comm = aksy.sysex.Command('\x12\x07', 'set_fx_override', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x07'] = comm
          comm = aksy.sysex.Command('\x12\x08', 'set_fx_send_level', (aksy.sysex.SWORD,), ())
          self.commands['\x12\x08'] = comm
          comm = aksy.sysex.Command('\x12\x09', 'set_zone_xfade', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x09'] = comm
          comm = aksy.sysex.Command('\x12\x0A', 'set_xfade_type', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x0A'] = comm
          comm = aksy.sysex.Command('\x12\x0E', 'set_polyphony', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x0E'] = comm
          comm = aksy.sysex.Command('\x12\x0F', 'set_zone_xfade_ctrl_no', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x0F'] = comm
          comm = aksy.sysex.Command('\x12\x10', 'set_tune', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x10'] = comm
          comm = aksy.sysex.Command('\x12\x11', 'set_keygroup_level', (aksy.sysex.SWORD,), ())
          self.commands['\x12\x11'] = comm
          comm = aksy.sysex.Command('\x12\x18', 'set_play_trigger', (), ())
          self.commands['\x12\x18'] = comm
          comm = aksy.sysex.Command('\x12\x19', 'set_play_trigger_vel', (aksy.sysex.BYTE,), ())
          ...
          comm = aksy.sysex.Command('\x12\x22', 'set_filter_resonance', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x22'] = comm
          comm = aksy.sysex.Command('\x12\x23', 'set_filter_atten', (aksy.sysex.BYTE,), ())
          self.commands['\x12\x23'] = comm
          comm = aksy.sysex.Command('\x12\x30', 'set_env_rate1', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x30'] = comm
          comm = aksy.sysex.Command('\x12\x31', 'set_env_level1', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x31'] = comm
          comm = aksy.sysex.Command('\x12\x32', 'set_env_rate2', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x32'] = comm
          comm = aksy.sysex.Command('\x12\x33', 'set_env_level2', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x33'] = comm
          comm = aksy.sysex.Command('\x12\x34', 'set_env_rate3', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x34'] = comm
          comm = aksy.sysex.Command('\x12\x35', 'set_env_level3', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x35'] = comm
          comm = aksy.sysex.Command('\x12\x36', 'set_env_rate4', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x36'] = comm
          comm = aksy.sysex.Command('\x12\x37', 'set_env_level4', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          ...
          comm = aksy.sysex.Command('\x12\x51', 'set_lfo_delay', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x51'] = comm
          comm = aksy.sysex.Command('\x12\x52', 'set_lfo_depth', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x52'] = comm
          comm = aksy.sysex.Command('\x12\x53', 'set_lfo_waveform', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
          self.commands['\x12\x53'] = comm
          comm = aksy.sysex.Command('\x12\x54', 'set_lfo_phase', (aksy.sysex.BYTE, aksy.sysex.BYTE), ())
