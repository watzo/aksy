...
class Multifxtools:
     def __init__(self, z48):
          self.z48 = z48
          self.commands = {}
          comm = aksy.devices.z48.sysex.Command('\x24\x01', 'is_fxcard_installed', (), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x24\x01'] = comm
          comm = aksy.devices.z48.sysex.Command('\x24\x10', 'get_no_channels', (), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x24\x10'] = comm
          comm = aksy.devices.z48.sysex.Command('\x24\x11', 'get_max_modules', (aksy.devices.z48.sysex.BYTE,), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x24\x11'] = comm
          comm = aksy.devices.z48.sysex.Command('\x24\x20', 'get_no', (), (aksy.devices.z48.sysex.WORD,))
          self.commands['\x24\x20'] = comm
          comm = aksy.devices.z48.sysex.Command('\x24\x21', 'get_name', (aksy.devices.z48.sysex.WORD,), (aksy.devices.z48.sysex.STRING,))
          self.commands['\x24\x21'] = comm
          comm = aksy.devices.z48.sysex.Command('\x24\x22', 'get_id', (aksy.devices.z48.sysex.WORD,), (aksy.devices.z48.sysex.DWORD,))
          self.commands['\x24\x22'] = comm
          comm = aksy.devices.z48.sysex.Command('\x24\x24', 'get_param_index_output_ctrl', (aksy.devices.z48.sysex.WORD,), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x24\x24'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x20', 'is_channel_muted', (), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x27\x20'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x21', 'get_channel_input', (aksy.devices.z48.sysex.BYTE,), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x27\x21'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x22', 'get_channel_output', (aksy.devices.z48.sysex.BYTE,), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x27\x22'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x30', 'get_by_name', (aksy.devices.z48.sysex.BYTE,), (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.STRING))
          self.commands['\x27\x30'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x31', 'get_by_index', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), (aksy.devices.z48.sysex.WORD,))
          self.commands['\x27\x31'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x40', 'is_module_enabled', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x27\x40'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x50', 'get_param_value', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), (aksy.devices.z48.sysex.SDWORD,))
          self.commands['\x27\x50'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x51', 'get_param_string', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), (aksy.devices.z48.sysex.STRING,))
          self.commands['\x27\x51'] = comm
          comm = aksy.devices.z48.sysex.Command('\x27\x52', 'get_param_qlinkctrl', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), (aksy.devices.z48.sysex.BYTE,))
          self.commands['\x27\x52'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x20', 'set_channel_mute', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), ())
          self.commands['\x26\x20'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x21', 'set_channel_input', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), ())
          self.commands['\x26\x21'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x22', 'set_channel_output', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), ())
          self.commands['\x26\x22'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x30', 'set_fx_by_id', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.STRING), ())
          self.commands['\x26\x30'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x31', 'set_fx_by_name', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.WORD), ())
          self.commands['\x26\x31'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x40', 'enable_module', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTES, aksy.devices.z48.sysex.DWORD), ())
          self.commands['\x26\x40'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x50', 'set_param_value', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), ())
          self.commands['\x26\x50'] = comm
          comm = aksy.devices.z48.sysex.Command('\x26\x52', 'set_param_qlinkctrl', (aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE, aksy.devices.z48.sysex.BYTE), ())
