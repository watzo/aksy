...
class Disktools:
     def __init__(self, z48):
          ...
          comm = sysex.Command('\x10','\x10', 'get_no_subfolders', (), (sysex.WORD,))
          ...
          comm = sysex.Command('\x10','\x17', 'delete_subfolder', (sysex.STRING,), ())
          ...
          comm = sysex.Command('\x10','\x28', 'rename_file', (sysex.STRING, sysex.STRING), ())
          ...
          comm = sysex.Command('\x10','\x2B', 'load_file_and_deps', (sysex.STRING,), ())
          self.commands[('\x10', '\x2B')] = comm
          comm = sysex.Command('\x10','\x2C', 'save', (sysex.DWORD, sysex.BYTE, sysex.BOOL, sysex.BYTE ), ())
          self.commands[('\x10', '\x2C')] = comm
          comm = sysex.Command('\x10','\x2D', 'save_all', (sysex.BYTE, sysex.BOOL ), ())
     ...
     def save(self, arg0, arg1, arg2, arg3):
          ...
          return self.z48.execute(comm, (arg0, arg1, arg2, arg3, ), sysex.AKSYS_Z48_ID)
