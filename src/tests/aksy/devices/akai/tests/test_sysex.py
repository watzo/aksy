...
class TestAlternativeRequest(unittest.TestCase):
    def test_no_args(self):
        ...
        self.assertEqual('\xf0G_\x00`\x03\x00\x00\x04\x00\x01P\xf7', req.get_bytes())
    ...
    def test_with_args(self):
        ...
        self.assertEqual('\xf0G_\x00`\x02\x00\x00\x04\x00\x02&\x01\x02&\x02\xf7', req.get_bytes())
    ...
    def test_with_multiple_args(self):
        ...
        self.assertEqual('\xf0G_\x00a\x02\x00\x00\x04\x00\x05\t\x01\x00\x01\x00\x05\t\x01\x00\x02\x00\xf7', req.get_bytes())
    ...
    def test_keygroup_index(self):
        ...
        self.assertEqual('\xf0G_\x00a\x07\x00\x00\x04\x00\x03\x020\x01\x020\x02\xf7', req.get_bytes())
